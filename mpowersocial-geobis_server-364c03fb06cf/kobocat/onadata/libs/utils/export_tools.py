...
from onadata.libs.utils.common_tags import (
    ...
    SUBMISSION_TIME, UUID, TAGS, NOTES,SUBMITTED_BY)
...
class ExportBuilder(object):
    ...
    if settings.SHOW_EXPORT_METADATA is True:
        EXTRA_FIELDS = [ID, UUID, SUBMISSION_TIME, INDEX, PARENT_TABLE_NAME,
                    PARENT_INDEX, TAGS, NOTES, SUBMITTED_BY]
    else:
        EXTRA_FIELDS = []
                ...
                for element in section['elements']:
                    ...
                    if element.has_key('label'):
                        if element['label'] == '':
                            ...
                            if isinstance(element['label'],dict) and self.LABEL_LANG  in element['label']:
                                print element['label']
                                #print self.LABEL_LANG
                                #print element['label'][self.LABEL_LANG]
